...
class AddrMan:
    def __init__(self, max_addresses: int = 10000):
    ...
    def add_static_peer(self, address: str) -> None:
    ...
    def add_bootstrap_nodes(self, nodes: List[str]) -> None:
        for node in nodes:
            self.add_static_peer(node)
        if nodes:
