...
def register_default_handlers(server: RPCServer, node: Any) -> None:
    ...
    methods: Dict[str, Handler] = {
        ...
        'list_peers': control.list_peers,
        'verify_peer': control.verify_peer,
        'join_network': control.join_network,
        'get_blockchain_info': chain.get_blockchain_info,
        'getblockchaininfo': chain.get_blockchain_info,
        'get_block': chain.get_block,
        'getblock': chain.get_block,
        'get_block_header': chain.get_block_header,
        'getblockheader': chain.get_block_header,
        'get_best_block_hash': chain.get_best_block_hash,
        'get_block_count': chain.get_block_count,
        'get_block_hash': chain.get_block_hash,
        'getblockhash': chain.get_block_hash,
        'getrawtransaction': chain.get_raw_transaction,
        'get_raw_transaction': chain.get_raw_transaction,
